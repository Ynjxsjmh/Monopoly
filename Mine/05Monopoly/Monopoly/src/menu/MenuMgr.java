...
public class MenuMgr {
	...
	protected MenuMgr() {
		...
		menuList[MenuID.SKILL_MENU] = new SkillMenu(MenuID.SKILL_MENU);
		menuList[MenuID.CARD_MENU] = new CardMenu(MenuID.CARD_MENU);
		menuList[MenuID.MAGIC_MENU] = new MagicMenu(MenuID.MAGIC_MENU);
	}
