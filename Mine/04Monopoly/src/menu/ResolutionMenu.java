...
public class ResolutionMenu extends Menu {
    ...
    public boolean doChoice(int choice, OutDevice outDevice) {
        switch(choice) {
        case 1: { outDevice.drawLn("Resolution has been set to 640X320"); Game.getGame().setCurrentMenu(MenuID.OPTION_MENU);  break; }
        case 2: { outDevice.drawLn("Resolution has been set to 800X600"); Game.getGame().setCurrentMenu(MenuID.OPTION_MENU);  break; }
        case 3: { outDevice.drawLn("Resolution has been set to 1024X768"); Game.getGame().setCurrentMenu(MenuID.OPTION_MENU); break; }
