...
public class SaveMenu extends Menu {
    ...
    public boolean doChoice(int choice, OutDevice outDevice) {
        ...
        switch(choice) {
        case 1: { outDevice.drawLn("建立存档1"); break; }
        case 2: { outDevice.drawLn("建立存档2"); break; }
        case 3: { outDevice.drawLn("建立存档3"); break; }
        case 4: { outDevice.drawLn("建立存档4"); break; }
        case 5: { outDevice.drawLn("建立存档5"); break; }
