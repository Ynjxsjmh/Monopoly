...
void PlayMenu::show(const OutDevice& dev) const
{
    ...
    dev.drawLn("1. Go...");
    dev.drawLn("2. ApplyFlyCard To Self");
    dev.drawLn("3. ApplyMeanCard");
    dev.drawLn("4. ApplyReturnSpell");
    dev.drawLn("5. ApplyHurtSpell");
    dev.drawLn("6. ApplyLuckCard");
    dev.drawLn("7. ApplyExFlyCard");
    dev.drawLn("8. ApplySuperCard");
    dev.drawLn("9. Load");
    dev.drawLn("10. Save");
...
bool PlayMenu::doChoice(int choice, const OutDevice& dev)
{
    ...
    case 2: {
        ...
        Command* cmd = new FlyCardCommand(cur);
        cur->apply(cmd);
        delete cmd;
        break;
    }
    ...
    case 5: {
        Player* cur    = Players::getPlayers().curPlayer();
        Player* target = Players::getPlayers().getPlayer(1);
        Command* cmd = new HurtSpellCommand(target);
        cur->apply(cmd);
        delete cmd;
        break;
    }
    case 6: {
        Player* cur    = Players::getPlayers().curPlayer();
        Player* target = Players::getPlayers().getPlayer(1);
        Command* cmd = new LuckCardCommand(target);
        cur->apply(cmd);
        delete cmd;
        break;
    }
    case 7: {
        Player* cur    = Players::getPlayers().curPlayer();
        Player* target = Players::getPlayers().getPlayer(1);
        Command* cmd = new ExFlyCardCommand(target);
        cur->apply(cmd);
        delete cmd;
        break;
    }
    case 8: {
        Player* cur    = Players::getPlayers().curPlayer();
        Player* target = Players::getPlayers().getPlayer(1);
        Command* cmd = new SuperCardCommand(target);
        cur->apply(cmd);
        delete cmd;
        break;
    }
