...
class LuckCardCommand: public CardCommand
{
public:
    LuckCardCommand(Player* tgt);
    virtual ~LuckCardCommand() {}
    virtual void excute();
private:
    Player* target;
};
class ExFlyCardCommand: public CardCommand
{
public:
    ExFlyCardCommand(Player* tgt);
    virtual ~ExFlyCardCommand() {}
    virtual void excute();
private:
    Player* target;
};
class SuperCardCommand: public CardCommand
{
public:
    SuperCardCommand(Player* tgt);
    virtual ~SuperCardCommand() {}
    virtual void excute();
private:
    Player* target;
};
...
class HurtSpellCommand: public SpellCommand
{
public:
    HurtSpellCommand(Player* tgt);
    virtual ~HurtSpellCommand() {}
    virtual void excute();
private:
    Player* target;
};
