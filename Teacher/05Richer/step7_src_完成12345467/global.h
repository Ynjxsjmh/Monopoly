...
{
public:
    static const int PLAYER_TYPE_UNKNOW = 0;
    static const int PLAYER_TYPE_HUMAN = 1;
    static const int PLAYER_TYPE_AUTO = 2;
    static const int PLAYER_TYPE_COUNT = 3;
};
class MoneyStateID
{
public:
    static const int MONEY_STATE_NONE = 0;
    static const int MONEY_STATE_HURT = 1;
    static const int MONEY_STATE_LUCK = 2;
    static const int MONEY_STATE_COUNT = 3;
};
...
public:
    ...
    static const int MOVE_STATE_EXFLY = 3;
    static const int MOVE_STATE_COUNT = 4;
};
class StrategyID
{
public:
